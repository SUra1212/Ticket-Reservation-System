...
export default function CancelTicketRes() {
    ...
    const UpdateTicketRes = (e) => {
        ...
        axios.put(`https://localhost:7227/api/TicketRes/${id}`, data)
            .then(res => {
                console.log(res)
                notifyCancelRes();
                setTimeout(() => {
    ...
    return (
        ...
        <div className="page-container">
            <form onSubmit={UpdateTicketRes} className='container card ticket-res-card'>
                ...
                <MDBInput disabled={true} name="noOfPassengers" value={ticketres.noOfPassengers} onChange={handleInput} wrapperClass='mb-4' type='number' id='form6Example6' />
